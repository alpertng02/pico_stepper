...
template <uint slice> static bool stepper_timer_callback(repeating_timer *rt) {
...
#ifdef DEBUG_LOG
      printf("Slice %u, Pos %ld, Speed %lld, is in bounds and turning.\n",
             slice, stpPos[slice], speedFp);
#endif
